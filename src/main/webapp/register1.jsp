            ...
            <div class="col-auto shadow my-2 pb-5 bg-light rounded-3">
                ...
                <form action="bhashaVidhya1" >
                    ...
                    <div class="mb-3">
                     ...
                     <input type="text" name="ecompany" class="form-control rounded-pill" value="BhashaVidya" required>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputContact" class="form-label">ContactNo</label>
                        <input type="text" name="econtactno" class="form-control rounded-pill" name="econtactno"
                            pattern="[+]{1}[1-9]{2}[0-9]{10}" title="add country code and remaing 10 digit with 0-9"
